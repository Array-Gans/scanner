...
class ZeroScann():
    ...
    def scan(self):
        ...
        parser = argparse.ArgumentParser(prog="arrayscan.py", description="Simple Find Shell in Website")
        parser.add_argument("-u", dest="domain", help="your url")
        parser.add_argument("-w", dest="wordlist", help="your wordlsit")
        args = parser.parse_args()
        if not args.domain:
            sys.exit("\033[36musage: scan.py -u example.com -w wordlist.txt")
 ...
 # ================================== #
 # Shell Scanner                      #
 # Coded by Array                     #\033[0m
 # Whatshap: 081297980371             #
 # Email   : indodefacer@gmail.com    #
 # ================================== #
              """
        return info
    print(banner())
